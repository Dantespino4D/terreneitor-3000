...
void Motores::begin(){
    ...
    ledc_timer.duty_resolution  = LEDC_TIMER_11_BIT;    // Resolución de 8 bits (Valores de 0 a 2047)
...
void Motores::avanzar(uint16_t velocidad){
...
void Motores::girarIzquierda(uint16_t velocidad){
...
void Motores::girarDerecha(uint16_t velocidad){
    gpio_set_level(pin_ain1, 1);
    gpio_set_level(pin_ain2, 0);
...
void Motores::retroceder(uint16_t velocidad){
